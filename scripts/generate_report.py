"""
Report Generator for TrustLens Reddit Multimodal Case Dataset
Generates output/dataset_intelligence_report.md
"""

import json
from pathlib import Path

OUT_DIR = Path("/Users/nandinikhandelwal/Desktop/Codes/trustlens/trustlens_reddit_multimodal_dataset/output")
REPORT_PATH = OUT_DIR / "dataset_intelligence_report.md"
REPORT_PATH_ROOT = Path("/Users/nandinikhandelwal/Desktop/Codes/trustlens/trustlens_reddit_multimodal_dataset/dataset_intelligence_report.md")

report_content = """# TRUSTLENS — REDDIT MULTIMODAL DATASET INTELLIGENCE REPORT
...
with open(REPORT_PATH_ROOT, "w") as f:
    f.write(report_content)

print(f"Report written to {REPORT_PATH} and {REPORT_PATH_ROOT}")
