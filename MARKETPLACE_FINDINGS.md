...
1. **Query Contamination**:
   - The `iphone` search corpus (10 direct device matches) contains **0 related accessory listings** (cases, chargers, covers) and **0 unrelated device listings** (Samsung, OnePlus, Android devices).
...
3. **Price Delta Hypothesis Evaluation**:
   - Across **10** listings in comparable groups (N ≥ 5), exactly **2 listings (20.00%) fall $\le -35\%$ below their specific model median**.
   - Exactly **2 listings (20.00%) fall $\le -50\%$ below their specific model median**.
